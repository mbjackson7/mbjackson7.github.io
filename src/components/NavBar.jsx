...
export default function NavBar() {
  return (
    <div className="h-screen w-[20vmin] min-w-[20vmin] border-r-2 flex flex-col fixed">
      ...
      <div className="h-full flex flex-col text-center items-center">
        ...
        <div className="p-2">
          <a href="https://www.linkedin.com/in/morganjackson-68-65-6c-6c-6f/">
            <img className="p-2" src="https://img.shields.io/badge/LinkedIn-blue?style=round-square&logo=Linkedin&logoColor=white&link=https://www.linkedin.com/in/morganjackson-68-65-6c-6c-6f/" alt="LinkedIn Link"/>
          </a>

          <a href="https://github.com/mbjackson7">
            <img className="p-2" src="https://img.shields.io/github/followers/mbjackson7?label=GitHub&style=social" alt="GitHub Link"/>
          </a>
        </div>
